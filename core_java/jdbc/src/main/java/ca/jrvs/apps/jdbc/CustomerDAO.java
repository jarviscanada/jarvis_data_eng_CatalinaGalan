...
public class CustomerDAO extends DataAccessObject<Customer> {
  ...
  public static final String GET_ONE = "SELECT customer_id, first_name, "
      + "last_name, email, phone, address, city, state, zipcode"
      + " FROM customer WHERE customer_id = ?";

  public static final String UPDATE = "UPDATE customer SET first_name = ?, "
      + "last_name = ?, email = ?, phone = ?, address = ?, city = ?, state = ?, "
